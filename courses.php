...
<div class="container-fluid courses-section">
    <div class="row">
        <div class="d-flex justify-content-between align-items-center">
             <div>
              <h3 class="page-top-heading">Courses</h3>
              <p style="font-size:13px;" class="mb-0 mt-1 text-muted">View all Courses !</p>
              </div>  
             <a href="add_course.php" class="btn feature-btn"><i class="fa-solid fa-plus me-2"></i>Add Course</a>
        </div>
    </div>
                                ...
                                <table id="data-table" class="table nowrap align-middle" style="width:100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>23/1/2023 00:00:00</td>
                                                <td>23/1/2023 00:00:00</td>
                                                <td>$799.00</td>
                                                <td>$699.00</td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="edit_course.php" type="button" class="btn transparent-btn"><i class="fa-regular fa-pen-to-square edit-icon"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="edit_course.php" type="button" class="btn transparent-btn"><i class="fa-regular fa-pen-to-square edit-icon"></i></a>
                                                        <button type="button" data-bs-toggle="modal" data-bs-target="#DeleteModal" class="btn transparent-btn mx-2"><i class="fa-regular fa-trash-can delete-icon"></i></button>
                                                        <button data-bs-toggle="modal" data-bs-target="#UnhideCourseModal" type="button" class="btn transparent-btn"><i class="fa-regular fa-eye-slash eye-icon"></i></button>
                                                    </div>
                                                </td>
                                            </tr>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="p-3">
                                                        <div class="text-center">
                                                            ...
                                                            <p style="font-size: 15px;" class="text-muted my-2">Are you sure want to delete this Course?</p>
                                                        </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="p-3">
                                                        <div class="text-center">
                                                            ...
                                                            <p class="my-4 are-you-sure">Are You Sure</p>
                                                            <p style="font-size: 15px;" class="text-muted my-2">Are you sure want to hide this Course?</p>
                                                        </div>
                                                        <div class="d-flex align-items-center mt-5 mb-3">
                                                            <button  data-bs-dismiss="modal" class="btn btn-light cancel-btn me-3">Cancel</button>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="p-3">
                                                        <div class="text-center">
                                                            ...
                                                            <p class="my-4 are-you-sure">Are You Sure</p>
                                                            <p style="font-size: 15px;" class="text-muted my-2">Are you sure want to Unhide this Course?</p>
                                                        </div>
                                                        <div class="d-flex align-items-center mt-5 mb-3">
                                                            <button  data-bs-dismiss="modal" class="btn btn-light cancel-btn me-3">Cancel</button>
